...
function MonthMentorSlide() {
  return (
    ...
    <div className=" max-[360px]:w-[290px] max-[395px]:w-[310px] w-[340px] lg:w-[790px] h-full ">
      <Swiper
        navigation={true}
        mousewheel={true}
        keyboard={true}
          ...
          <SwiperSlide key={index}>
            <div className="p-5  w-full  bg-white rounded-[10px] ">
              <div className="flex">
                ...
                <button className="text-[#546FFF] text-sm font-medium ml-5">
                  + Follow
                </button>
              </div>
